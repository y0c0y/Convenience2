...
public class CustomAdapter_gs extends RecyclerView.Adapter<CustomAdapter_gs.CustomViewHolder> {

    private ArrayList<gs_spe_> arrayList;
    private Context context;

    public CustomAdapter_gs(ArrayList<gs_spe_> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_gs_spe,parent,false);
