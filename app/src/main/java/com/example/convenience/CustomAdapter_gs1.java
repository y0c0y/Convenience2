...
public class CustomAdapter_gs1 extends RecyclerView.Adapter<CustomAdapter_gs1.CustomViewHolder> {

    private ArrayList<gs_opo_> arrayList;
    private Context context;

    public CustomAdapter_gs1(ArrayList<gs_opo_> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_gs_opo,parent,false);
