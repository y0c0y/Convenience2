...
public class CustomAdapter_cu2 extends RecyclerView.Adapter<CustomAdapter_cu2.CustomViewHolder> {

    private ArrayList<cu_tpo_> arrayList;
    private Context context;

    public CustomAdapter_cu2(ArrayList<cu_tpo_> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_cu_tpo,parent,false);
