...
public class CustomAdapter_cu1 extends RecyclerView.Adapter<CustomAdapter_cu1.CustomViewHolder> {

    private ArrayList<cu_opo_> arrayList;
    private Context context;

    public CustomAdapter_cu1(ArrayList<cu_opo_> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.list_cu_opo,parent,false);
